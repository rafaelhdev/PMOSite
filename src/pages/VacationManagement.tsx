                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {v.status === 'approved' && (
                    <button
                      ...
                      className="bg-success-600 text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-success-700 transition-colors"
                    >
                      ✓ Confirmar Aprovação
                    </button>
                  )}
                  ...
                  {v.fluigStatus === 'not_sent' && v.status !== 'denied' && (
                    <button
                      ...
                      className="bg-warning-600 text-white px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-warning-700 transition-colors"
                    >
                      Abrir no Fluig
                    </button>
                  )}
                  ...
                  {v.fluigStatus === 'pending' && (
                    <button
                      ...
                      className="border border-warning-500 text-warning-700 px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-warning-50 transition-colors"
                    >
